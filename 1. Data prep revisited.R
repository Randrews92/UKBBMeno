...
##### No need to run this script, just gives info on the processes used to prep and join data.  
...
# We also need to exclude withdrawn particpants. 
...
# Use dx download fullcog_reg.csv to get the full set


fullcog_reg <- read.csv("fullcog_reg.csv")
